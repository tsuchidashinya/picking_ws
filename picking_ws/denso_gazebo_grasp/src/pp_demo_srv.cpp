...
int main(int argc, char **argv)
{
  ...
  {
    std::cout << "wait octomap" << std::endl;
    if (!pclient.call(psrv))
    {
      ROS_INFO("Failed pub_octmap");
    }
    else
    {
      ROS_INFO("Success pub_octmap");
    }
